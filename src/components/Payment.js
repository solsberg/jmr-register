  ...
  return (
    <div className="mb-5">
      ...
      {!isOnline && hasCovidPolicy && !storedAcceptedCovidPolicy &&
        <div className="mt-3">
          <h5>JMR35 COVID Policy</h5>
          <div className="col-md-8">
            Please <a href="/covidpolicy.html" onClick={onReadCovidPolicy} target="_blank">click here to open and read the JMR35 COVID Policy</a> and then acknowledge below
          </div>
          <div className="form-check col-md-8 mt-2">
            ...
            <label className="form-check-label" htmlFor="covidpolicy">
              I confirm that I have read and understand the JMR35 COVID Policy described above and agree to abide
              by its requirements and guidelines while attending JMR35
            </label>
          </div>
        </div>
      }
      {!isOnline && hasCovidPolicy && storedAcceptedCovidPolicy &&
        <small className="font-italic">
          You have already accepted the <a href="/covidpolicy.html" target="_blank">JMR35 COVID Policy</a>.
        </small>
      }
