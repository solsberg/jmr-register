...
class ScholarshipForm extends React.Component {
  ...
  renderYMLForm = () => {
    ...
    return (
      <div>
        <p>
          The Jewish Men’s Retreat Fellowship Program for Young Men is for adult men ages eighteen through thirty-five who demonstrate an interest in attending the annual Jewish Men’s Retreat, now in its 32nd year.
        ...
        <ul>
          ...
          <li>Commit to attending the entire JMR32 program (4pm Friday, October 27, 2023, through the closing circle on Sunday afternoon, October 29, 2023).</li>
          <li>Complete the JMR Fellows Program application</li>
        </ul>

        <p>Benefits:</p>
        <ul>
          <li>Full financial support to attend JMR32 - October 27-29, 2023 (for first time attendee)</li>
          <li>50% financial support to attend JMR32 - October 27-29, 2023 (for second time attendee)</li>
        ...
        <p className="small">
          ...
          As such, the availability of fellowships is limited in any given year.  To maximize the opportunity to receive a fellowship, we encourage you to submit the scholarship application no later than June 15, 2023.
          ...
          Applicants will be notified of the decision no later than July 1, 2023. Applications received after June 15, 2023 will be considered on a funds-available basis in the order in which the application is received and notified within twenty-one days after the application is received.
        </p>
    ...
    return (
      <div>
        <p className="small">
          ...
          To maximize the opportunity to receive a scholarship, we encourage you to submit the scholarship application no later than June 15, 2023.
          ...
          Applicants will be notified of the decision no later than July 1, 2023.
          Applications received after June 15, 2023 will be considered on a funds-available basis in the order in which the application is received and notified within twenty-one days after the application is received.
        </p>
        <p className="small">
        ...
        <div className="form-row m-2">
          <div className="form-group w-100">
            <label htmlFor="aid-support">Are you in a position to ask an individual or community organization (i.e. synagogue, Jewish federation, JCC, etc.) to help sponsor your attendance at JMR32?  If yes, Menschwork, Inc. will provide a letter on your behalf about the retreat and the benefits it offers to you and your Jewish community.</label>
