...
const ScholarshipForm = ({ event, currentUser }) => {
  ...
  const renderYMLForm = () => {
    return (
      <div>
        <p>
          The Jewish Men’s Retreat Fellowship Program for Young Men is for adult men ages eighteen through thirty-five who demonstrate an interest in attending the annual Jewish Men’s Retreat, now in its 35th year.
        ...
        <ul>
          ...
          <li>Commit to attending the entire JMR35 program (4pm Friday, October 16, 2026, through the closing circle on Sunday afternoon, October 18, 2026).</li>
          <li>Complete the JMR Fellows Program application</li>
        </ul>

        <p>Benefits:</p>
        <ul>
          <li>Full financial support to attend JMR35 - October 16 - October 18, 2026 (for first time attendee)</li>
          <li>50% financial support to attend JMR35 - October 16 - October 18, 2026 (for second time attendee)</li>
        ...
        <p className="small">
          ...
          As such, the availability of fellowships is limited in any given year.  To maximize the opportunity to receive a fellowship, we encourage you to submit the scholarship application no later than June 15, 2026.
          ...
          Applicants will be notified of the decision no later than July 1, 2026. Applications received after June 15, 2026 will be considered on a funds-available basis in the order in which the application is received and notified within twenty-one days after the application is received.
        </p>
    ...
    return (
      <div>
        <p className="small">
          ...
          To maximize the opportunity to receive a scholarship, we encourage you to submit the scholarship application no later than June 15, 2026.
          ...
          Applicants will be notified of the decision no later than July 1, 2026.
          Applications received after June 15, 2026 will be considered on a funds-available basis in the order in which the application is received and notified within twenty-one days after the application is received.
        </p>
        <p className="small">
        ...
        <div className="form-row m-2">
          <div className="form-group w-100">
            <label htmlFor="aid-support">Are you in a position to ask an individual or community organization (i.e. synagogue, Jewish federation, JCC, etc.) to help sponsor your attendance at JMR35?  If yes, Menschwork, Inc. will provide a letter on your behalf about the retreat and the benefits it offers to you and your Jewish community.</label>
